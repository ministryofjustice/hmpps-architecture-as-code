...
class NOMIS(model: Model) {
  ...
  init {
    ...
    nomis.addContainer("NOMIS API (Deprecated)",
        "(Deprecated) REST API for NOMIS which connects to Oracle DB. Deprecated - please use Elite2 API instead.",
        null).apply {
    ...
    nomis.addContainer("Offender Events",
