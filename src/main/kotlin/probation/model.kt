...
fun probationModel(model: Model) {
  ...
  Delius.system.uses(interventionsManager, "pushes active sentence requirements or licence conditions which are of interest to IM to", "IAPS")
  ...
  interventionsManager.uses(Delius.system, "pushes contact information of interest to")
