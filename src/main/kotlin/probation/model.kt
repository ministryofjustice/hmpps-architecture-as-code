...
fun probationModel(model: Model) {
  ...
  contractManager.uses(epfManager, "sends a signed off version of the CRC's Discretionary Services rate card brochure to", null, null)
  ...
  crcProgrammeManager.uses(deliusSupport, "opens tickets to update interventions", null, null)
  ...
  epfManager.uses(sentencingPolicy, "listens to owners of interventions for changes in policy", null, null)
  interventionServices.uses(delius, "creates new interventions in", null, null)
  interventionServices.uses(epfManager, "provide programme suitability guide for accredited programme eligibility to", null, null)
