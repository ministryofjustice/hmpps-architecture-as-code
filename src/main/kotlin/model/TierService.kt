...
class TierService private constructor() {
  companion object : HMPPSSoftwareSystem {
    ...
    override fun defineViews(views: ViewSet) {
      ...
      views.createSystemContextView(TierService.system, "tier-service-context", null).apply {
        addDefaultElements()
        enableAutomaticLayout(AutomaticLayout.RankDirection.TopBottom, 300, 300)
      }

      views.createContainerView(TierService.system, "tier-service-container", null).apply {
        addDefaultElements()
